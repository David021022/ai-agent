...
/*        String answer1 = loveApp.doChat("你好，我是程序员鱼皮", chatId);
    ...
    void doChatWithReport() {
        ...
        assertThat(loveReport).isNotNull();
    }
    ...
    void doChatWithMcp() {
        String chatId = UUID.randomUUID().toString();
/*
        String message = "我的另一半居住在上海静安区，请帮我找到5公里内适合约会的地点";
